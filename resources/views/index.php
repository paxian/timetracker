...
<html>
  ...
  <body ng-app="timeTracker" ng-controller="TimeEntry as vm">
    <nav class="navbar navbar-default">
      ...
      <div class="container-fluid time-entry">
        <div class="timepicker">
          <span clas="timepicker-title label label-primary">Clock In</span>
    ...
    <div class="container">
      <div class="col-sm-8">
        <div class="well timentry" ng-repeat="time in vm.timeentries">
          <div class="row">
            <div class="col-sm-8">
            ...
            <div class="col-sm-4 time-numbers">
              ...
              <h2>
                <span class="label label-primary" ng-show="time.loggedTime.duration._data.hours > 0">
                  ...
                  <span ng-show="time.loggedTime.duration._data.hours > 1"></span>
                </span>
              </h2>
